...
from .views import StudentCreateView, StudentDeleteView,StudentUpdateView, StudentDetailView, StudentUpdateView, home,student_list,HomeView, StudentListView, student_add, student_detail, student_update,student_delete
